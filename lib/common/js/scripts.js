 ...
 * ex :
 *    {
 *      required1 : 'family_name1 given_name1',
 *      required2 : 'family_name2 given_name2',
  ...
  'required_all' : function(){
    ...
    $items.each(function(){
      ...
      $(this).rules('add', {
        ...
        messages :{
          require_from_group : 'このフィールドは必須です。123'
        }
      });
    });
  },
  'required_tel' : function(){
    ...
    $items.each(function(){
      $(this).rules('add', {
        ...
        require_from_group : [$items.length, '[data-valid-group-item]'],
        messages :{
          require_from_group : 'このフィールドは必須です。456'
        }
      });
    });
  },
